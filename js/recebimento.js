                                    ...
                                    Object.keys(projeto.listas).forEach(nomeLista => {
                                        ...
                                        const processarItemDaLista = (itemOriginal, itemKey) => {
                                            if (itemOriginal && itemOriginal.status && typeof itemOriginal.status === 'string' &&
                                                (itemOriginal.status.includes('Comprado') || itemOriginal.status.includes('Empenho/Comprado') || itemOriginal.status === 'Pendente') && // Apenas itens pendentes ou comprados
                                                ...
                                                itemOriginal.status !== 'Concluído' && itemOriginal.status !== 'Incorreto' // Exclui explicitamente Concluído e Incorreto
                                            ) {
