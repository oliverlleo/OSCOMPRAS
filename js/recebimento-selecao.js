...
function salvarRecebimentoMelhorado(item, recebimento) {
    return new Promise((resolve, reject) => {
        try {
            ...
            if (!item || !item.ref || !item.ref.clienteId || !item.ref.tipoProjeto || !item.ref.nomeLista || !item.ref.itemKey) {
                console.error('Item sem referências completas:', item);
                resolve({ sucesso: false, mensagem: 'Item sem referências completas' });
                return;
            }
            ...
            window.dbRef.projetos
                ...
                .then(() => {
                    ...
                    return adicionarHistoricoRecebimento(item, recebimento);
                })
                .then(() => {
